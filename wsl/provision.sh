...
ansible-playbook -i loclhost, $CONFIGURE_ROOT/bootstrap.yml 
ansible-playbook -i loclhost, $CONFIGURE_ROOT/profile.yml 
ansible-playbook -i loclhost, $CONFIGURE_ROOT/deplenv.yml 
